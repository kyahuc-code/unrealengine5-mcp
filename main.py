...
def main():
    ...
    print("  - Registering Figma import tools...", file=sys.stderr)
    register_figma_import_tools(mcp)
    ...
    print("  - Figma Import: Convert Figma designs to Widget Blueprints", file=sys.stderr)
